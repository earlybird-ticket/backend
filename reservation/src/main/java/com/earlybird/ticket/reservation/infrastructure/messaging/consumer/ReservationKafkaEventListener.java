...
public class ReservationKafkaEventListener {
    ...
    @KafkaListener(topics = {TEST_TOPIC, SEAT_TO_RESERVATION_FOR_PREEMPT_TOPIC, SEAT_TO_RESERVATION_TOPIC, COUPON_TO_RESERVATION_TOPIC, PAYMENT_TO_RESERVATION_TOPIC, CREATE_RESERVATION_DLT}, containerFactory = "kafkaListenerContainerFactory", concurrency = "50")
