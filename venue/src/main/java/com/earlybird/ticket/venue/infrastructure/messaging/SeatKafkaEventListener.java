...
public class SeatKafkaEventListener {
    ...
    @KafkaListener(topics = {EventType.Topic.RESERVATION_TO_SEAT_FOR_PREEMPT_TOPIC}, containerFactory = "kafkaListenerContainerFactory", groupId = "test-group-id", concurrency = "50")
    public void listenReservationToSeatForPreemptTopic(@Payload String message,
                                                       Acknowledgment ack) {
    ...
    @KafkaListener(topics = {EventType.Topic.RESERVATION_TO_SEAT_TOPIC,}, containerFactory = "kafkaListenerContainerFactory", groupId = "test-group-id", concurrency = "20")
